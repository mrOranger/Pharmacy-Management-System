	...
	<body>
	    <div class="d-flex justify-content-center align-items-center login-container">
	        <div class="login-form text-center">
	            <h1 class="mb-5 font-weight-light text-uppercase" id = "header">Login</h1>
	            ...
	            <button type="button" class="btn mt-5 rounded-pill btn-lg btn-custom btn-block text-uppercase" onclick = "submit()">Log in</button>
	            <p class="mt-3 font-weight-normal">Don't have an account? <a href="/PharmacyManagementSystem/register.jsp"><strong>Register Now</strong></a></p>
	        </div>
	    </div>
