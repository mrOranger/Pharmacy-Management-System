...
<%@ page import = "com.pharmacyManagementSystem.model.UnbrandedMedicine" %>
...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="css/findUnbrandedStyle.css">
	    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css" integrity="sha384-UHRtZLI+pbxtHCWp1t77Bi1L4ZtiqrqD80Kn4Z8NTSRyMA2Fd33n5dQ8lWUE00s/" crossorigin="anonymous">
		<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
		<title>Find Unbranded Medicines</title>
	</head>
	<body>
		<%
		...
		<div class = "container-fluid">
			...
			<table class = "table">
				...
				<%
					int index = 0;
					for(UnbrandedMedicine m : ((LinkedList<UnbrandedMedicine>)request.getAttribute("medicines"))){
						%>
							<tr id = "row-<%= index %>">
								<td><%= m.getName() %></td>
								<td><%= m.getDescription() %></td>
								<td><%= m.getCost() %></td>
								<td><%= m.getBrandedMedicine() %></td>
		...
		<script type = "text/javascript" src = "script/findUnbrandedScript.js"></script>
